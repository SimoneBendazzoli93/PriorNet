...
from Autoinpainting.libs.gconv_layer import GConv2D
from Autoinpainting.libs.losses import l1_error, gram_matrix, total_variation, laploss
from Autoinpainting.libs.pconv_layer import PConv2D
...
class UNetModel(Model):
    ...
    def __init__(self,
                 ...
                 l4_factor=0.05, l5_factor=0.05, l6_factor=250, l7_factor=20,
                 *args, **kwargs
                 ):
    ...
    def build_vgg(self, img_rows, img_cols):
        ...
        vgg.load_weights("/opt/algorithm/vgg16")
